...
export class MindmapService {
  ...
  async getMindmapById(mindmapId: string): Promise<{ mindmap: any }> {
  ...
  async deleteMindmap(mindmapId: string) {
    const result = await this.mindmapRepository.deleteMindmapById(mindmapId);
    return result;
  }
}
